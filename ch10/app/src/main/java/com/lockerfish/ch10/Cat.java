...
public class Cat extends Pet implements Comparable<Cat> {
  ...
  public void eat(Food food) {
    System.out.println("Cat is eating " + food.getName());
  }

  @Override
  public double metabolizeFood(Food food) {
    return food.getCalories() / METABOLISM_RATING_FAST;
  }
  ...
  public int compareTo(Cat otherCat) {
    if (this.numWhiskers > otherCat.numWhiskers) {
      return 1;
    } else if (this.numWhiskers < otherCat.numWhiskers) {
      return -1;
    }
    return 0;
  }
